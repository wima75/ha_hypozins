...
from .const import (
    ...
    SNB_DEVICE_KEY,
    SNB_DEVICE_NAME,
    SWISSQUOTE_ATTRIBUTION,
    SWISSQUOTE_DEVICE_KEY,
    SWISSQUOTE_DEVICE_NAME,
)
...
ENTITY_DESCRIPTIONS: tuple[HypozinsSensorEntityDescription, ...] = (
    ...
    HypozinsSensorEntityDescription(
        key="swissquote_fest_2j",
        name="Festhypothek 2 Jahre",
        icon="mdi:home-percent",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        device_key=SWISSQUOTE_DEVICE_KEY,
        device_name=SWISSQUOTE_DEVICE_NAME,
        attribution=SWISSQUOTE_ATTRIBUTION,
        stand_key="swissquote_stand",
    ),
    HypozinsSensorEntityDescription(
        key="swissquote_fest_5j",
        name="Festhypothek 5 Jahre",
        icon="mdi:home-percent",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    HypozinsSensorEntityDescription(
        key="swissquote_saron_2j",
        name="SARON Hypothek 2 Jahre",
        icon="mdi:home-percent",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ...
    HypozinsSensorEntityDescription(
        key="swissquote_saron_5j",
        name="SARON Hypothek 5 Jahre",
        icon="mdi:home-percent",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
